...
const Laporan = ({ laporanPrivate, bulan, tahun, nextMonth, nextYear, prevMonth, prevYear }) => {
    ...
    const goToMonth = (month, year) => {
        Inertia.get(route('admin.rekap.private'), { bulan: month, tahun: year });
    };
    // const getTotal = (key) => {
        ...
        <DefaultLayout>
            ...
            <div className="col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div className="overflow-x-auto">
                 ...
                 <button onClick={() => goToMonth(prevMonth, prevYear)}>Bulan Sebelumnya</button>
                 <button onClick={() => goToMonth(nextMonth, nextYear)}>Bulan Selanjutnya</button>
             </div>
                </div>
            </div>
        </div>
