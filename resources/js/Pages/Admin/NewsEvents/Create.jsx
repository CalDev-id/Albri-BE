                                ...
                                <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <div>
                                        <label className="mb-2.5 block text-black dark:text-white font-medium">
                                            Judul Berita Acara <span className="text-red-500">*</span>
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">
                                            Gunakan toolbar di atas untuk formatting text, menambah gambar, link, dan lainnya.
                                        </p>
                                    </div>
                                </div>
